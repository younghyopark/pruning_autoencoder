    ...
    for remaining_connection in range(1,17):
        ...
        if x is None or "Starting the process with remaining connection {} using tech {}!\n".format(remaining_connection, tech) not in x:
            ...
            sparsity_levels={
                ...
                'bottleneck.bottleneck.weight':0,
            }
            ...
            # all_layers = [(pruned_model.encoder.fc1,'weight'),(pruned_model.encoder.fc2,'weight'),(pruned_model.encoder.fc3,'weight'),(pruned_model.encoder.fc4,'weight'),(pruned_model.decoder.fc4,'weight'),(pruned_model.decoder.fc3,'weight'),(pruned_model.decoder.fc2,'weight'),(pruned_model.decoder.fc1,'weight'),(pruned_model.bottleneck.bottleneck,'weight')] 
            ...
            if opt.pruning_technique == 0 :
                ...
                name = 'bottleneck.bottleneck.weight'
                scores = abs(trained_weight[name])
                prune.l1_unstructured(pruned_model.bottleneck.bottleneck, 'weight', sparsity_levels[name],scores)
            ...
            for this_layer in range(9):
                layer_sparsity = show_layer_sparsity(pruned_model, this_layer, verbose=True)
